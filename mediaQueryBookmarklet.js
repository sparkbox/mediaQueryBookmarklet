  ...
  function pageSize() {
    ...
    jQuery(window).bind('resize', function() {
      var cssProps = window.getComputedStyle(jQuery('body').get(0), null),
          width = $(window).width() || cssProps.getPropertyValue('width'),
          height = $(window).height() || cssProps.getPropertyValue('height');
