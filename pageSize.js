...
(function() {
  ...
  function pageSize() {
    ...
    jQuery(window).bind('resize', function() {
      var cssProps = window.getComputedStyle($('body').get(0), null),
